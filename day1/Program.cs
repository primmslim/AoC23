...
string testData = @"1abc2
pqr3stu8vwx
a1b2c3d4e5f
treb7uchet";


string prodData1 = @"14gxqgqsqqbxfpxnbccjc33eight
eight2sevenkl
...
Dictionary<string,int> TextToDigits = new Dictionary<string, int>(){
    {"one",1},
    {"two",2},
    {"three",3},
    {"four",4},
...
foreach(string line in prodData1.Split('\n')){
